...
[TestRegistrar](https://github.com/pedregon/mason/blob/main/v1/module_test.go) for an
...
[`Context`](https://github.com/pedregon/mason/blob/main/v1/context.go) using a
[`Registrar`](https://github.com/pedregon/mason/blob/main/v1/mason.go) handles
[`Module(s)`](https://github.com/pedregon/mason/blob/main/v1/module.go). *Loaded* modules provide services that are
...
`Registrar` inversion of control for `Service(s)` was abstracted. Mason by no means claims to be a perfect solution,
## Contributing
